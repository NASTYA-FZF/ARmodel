...
// ARmodel.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CARmodelApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CARmodelApp

CARmodelApp::CARmodelApp()
{
...
// Единственный объект CARmodelApp

CARmodelApp theApp;


// Инициализация CARmodelApp

BOOL CARmodelApp::InitInstance()
{
